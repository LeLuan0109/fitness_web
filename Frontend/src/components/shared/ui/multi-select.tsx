        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
          ...
          >
            <Command>
              ...
              >
                <CommandEmpty>{emptyIndicator || "Không tìm thấy kết quả."}</CommandEmpty>{" "}
                {!hideSelectAll && !searchValue && (
                  <CommandGroup>
                    <CommandItem
                      ...
                      aria-label={`Chọn tất ${getAllOptions().length} lựa chọn`}
                    ...
                    >
                      ...
                      <span>
                        (Chọn tất
                        {getAllOptions().length > 20 ? ` - ${getAllOptions().length} lựa chọn` : ""})
                      </span>
                    </CommandItem>
                  </CommandGroup>
                )}
