    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <TypographyH5 variant="bold" className="text-earth">
            Thống kê
          </TypographyH5>
              ...
              >
                ...
                <div className="bg-history-date-header rounded-xl px-6 py-4 flex justify-between items-center border border-history-border-gray/50 shadow-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-earth text-sm font-semibold">{log.date}</span>
                  </div>
                  <div className="flex items-center gap-2 rounded-full border border-sand/60 bg-cream/70 px-3 py-1">
                    <Dumbbell className="w-3.5 h-3.5 text-primary" />
                    <span className="text-earth text-xs font-medium">{log.totalExercises} Bài tập</span>
                  </div>
                </div>
