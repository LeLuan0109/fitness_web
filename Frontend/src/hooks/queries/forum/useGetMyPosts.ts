import { getMyPosts } from "@/api/forum.api"
...
type MyPostsQueryResult = {
  posts: ForumPost[]
  pagination?: Pagination
}

export const useGetMyPosts = (params?: PostSearchParams) => {
  return useQuery<Response<ForumPost[]>, AxiosError<ResponseError>, MyPostsQueryResult>({
    queryKey: [QUERY_KEYS.FORUM.MY_POSTS, params],
