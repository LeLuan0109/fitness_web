...
import { CoreformCursor, CoreformLiftLoader, ThemeModeToggle } from "@/components/shared/coreform"
      ...
      <header className="sticky top-0 z-50 border-b border-sand/40 bg-cream/85 backdrop-blur-md">
        <div className="mx-auto flex h-16 w-full max-w-7xl items-center gap-3 px-4 sm:px-6 lg:px-8">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            <ThemeModeToggle triggerClassName="rounded-full text-earth hover:bg-sand-light/60 hover:text-earth" />
            ...
            <Button
              ...
              onClick={() => handleNavigate(ROUTES.WORKOUTS.SAMPLE_LIST)}
            >
              Bắt đầu ngay
            </Button>
