...
public class UpdateProfileRequest {
    ...
    // Request này nhận multipart/form-data (@ModelAttribute) nên Jackson @JsonFormat KHÔNG được áp dụng.
    // Cần @DateTimeFormat để Spring form-binding parse được chuỗi "dd/MM/yyyy" sang LocalDate.
